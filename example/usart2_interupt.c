/**
 * @file    usart2.c
 * @brief   Communication with stm32f401ccu6 by usart2, using interupt RXE
 *
 * @note    In this code i use basic array (tmp[16]) to handle data
 *          so if you guys transmit too much it could be overflow, custom it by your self
 */
...
void bdang_init_usart2_interrupt(void);
...
/**
 * @brief Init USART2 interrupt RXNE
 * 
 * @retval None
 */
void bdang_init_usart2_interrupt(void) {
